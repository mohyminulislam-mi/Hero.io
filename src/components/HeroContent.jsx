    ...
    return (
        <div>
            ...
            <div className='text-center mt-20'>
                <h1 className='text-5xl font-bold lg:py-[15px]'>We Build <br /> <span className='text-6xl text-purple-500'>Productive</span> Apps</h1>
                <p className=' p-[15px] text-[#627382]'>At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. <br /> Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
